...
//   Все указанные параметры будут сохранены в энергонезависимую память модуля:    //
     bool f[4];                                                                    //   Создаём массив из 5 флагов.
     ...
     f[3] = sensor.setPHn    (7.000  );                                            //   Нейтральная кислотность  (0...14,000 pH   ) при которой нет разности потенциалов. По умолчанию 7,000 pH.
                                                                                   //
//   Выводим результат записи настроек:                                            //
     if( f[0]&f[1]&f[2]&f[3]==true ){ Serial.println("Все настройки записаны");}   //
