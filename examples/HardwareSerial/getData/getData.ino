...
//   Выводим результат:                                                            //
     if( pH<0 ){ Serial.println( F("Нет ответа от pH-метра.") );     }             //   Сообщаем о ошибке чтения.
     else      { Serial.println( (String) "Кислотность "+pH+" pH."); }             //   Выводим полученный водородный показатель жидкости.
}                                                                                  //